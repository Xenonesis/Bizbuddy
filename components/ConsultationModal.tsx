...
import { X, Calendar, Clock, Building2, User, Phone, CheckCircle2, MessageSquare, ArrowRight } from "lucide-react";
          ...
          {isSubmitted ? (
            <div className="text-center py-6 space-y-4">
              ...
              <p className="text-sm text-[#60646c]">
                Thank you <span className="font-medium text-black">{formData.name}</span>! Our senior strategy advisor will call you at <span className="font-medium text-black">{formData.phone}</span> on {formData.date} during the selected time slot.
              </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              >
                {isSubmitting ? "Confirming..." : "Confirm Free Consultation Session"}
