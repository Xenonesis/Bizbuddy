			...
			<section className="hero-sky-wash pt-12 sm:pt-16 pb-10 sm:pb-14 border-b border-[#dcdee0] dark:border-[#27272a]">
				<div className="max-w-[1280px] mx-auto px-4 sm:px-6 text-center space-y-4">
					<div className="badge-pill">
						NEXT.JS 16 & REACT 19 WEB ENGINEERING
					</div>
					...
					<p className="text-base text-[#60646c] dark:text-zinc-400">
						Starting at ₹3,999. Custom designed landing pages, business
						websites, and e-commerce stores integrated with WhatsApp lead bots &
						Razorpay.
					</p>
				</div>
			</section>
			...
			<section className="max-w-[1280px] mx-auto px-4 sm:px-6">
				<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
					{WEBSITE_PACKAGES.map((pkg) => (
						<div
							key={pkg.id}
							className="card-surface bg-white dark:bg-[#14161b] border border-[#dcdee0] dark:border-[#27272a] rounded-xl p-6 sm:p-8 flex flex-col justify-between hover:border-[#171717] dark:hover:border-zinc-500 transition-all"
						>
							<div className="space-y-6">
								<div className="flex justify-between items-start border-b border-[#f0f0f3] dark:border-[#27272a] pb-4">
									...
									<div className="text-right">
										<div className="text-[10px] font-mono text-[#60646c] dark:text-zinc-400">
											STARTING AT
										</div>
								...
								<div className="space-y-3">
									...
									<ul className="space-y-2.5 text-sm">
										{pkg.features.map((feat) => (
											<li
												key={feat}
												className="flex items-center gap-2 text-[#171717] dark:text-[#f4f4f5]"
											>
								...
								<div className="bg-[#fafafa] dark:bg-[#0c0d10] p-3 rounded-lg border border-[#f0f0f3] dark:border-[#27272a] flex justify-between items-center text-xs font-mono">
									...
									<span className="font-semibold text-[#171717] dark:text-[#f4f4f5]">
										{pkg.turnaround}
									</span>
								</div>
							</div>
			...
			<section className="max-w-[1280px] mx-auto px-4 sm:px-6 bg-[#171717] dark:bg-[#000000] text-white rounded-2xl p-8 sm:p-12 space-y-6">
				<div className="text-center max-w-2xl mx-auto space-y-3">
					...
					<p className="text-sm text-zinc-400">
						Every site we build achieves 90+ Google PageSpeed scores, runs on
						secure SSL cloud hosting, and includes mobile-first responsive
						layouts.
					</p>
				</div>
