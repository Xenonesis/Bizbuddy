...
export default function DashboardPage() {
  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      <section className="bg-[#171717] dark:bg-[#000000] text-white py-10 px-4 sm:px-6">
      ...
      <section className="max-w-[1280px] mx-auto px-4 sm:px-6 space-y-8">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="card-surface p-5 space-y-2 bg-white dark:bg-[#14161b] border border-[#dcdee0] dark:border-[#27272a] rounded-xl">
            ...
            <div className="text-3xl font-bold font-mono text-[#171717] dark:text-[#f4f4f5]">148</div>
          ...
          <div className="card-surface p-5 space-y-2 bg-white dark:bg-[#14161b] border border-[#dcdee0] dark:border-[#27272a] rounded-xl">
            ...
            <div className="text-3xl font-bold font-mono text-[#171717] dark:text-[#f4f4f5]">84</div>
          ...
          <div className="card-surface p-5 space-y-2 bg-white dark:bg-[#14161b] border border-[#dcdee0] dark:border-[#27272a] rounded-xl">
            ...
            <div className="text-3xl font-bold font-mono text-[#171717] dark:text-[#f4f4f5]">210</div>
          ...
          <div className="card-surface p-5 space-y-2 bg-white dark:bg-[#14161b] border border-[#dcdee0] dark:border-[#27272a] rounded-xl">
            ...
            <div className="text-3xl font-bold font-mono text-[#171717] dark:text-[#f4f4f5]">₹2.45L</div>
        ...
        {activeTab === "leads" && (
          <div className="space-y-4">
            <div className="flex justify-between items-center">
              <h3 className="text-xl font-semibold text-[#171717] dark:text-[#f4f4f5]">Recent Inquiries & Leads</h3>
            ...
            <div className="card-surface bg-white dark:bg-[#14161b] border border-[#dcdee0] dark:border-[#27272a] overflow-x-auto rounded-xl">
              <table className="w-full text-left border-collapse min-w-[640px]">
                ...
                <tbody className="divide-y divide-[#f0f0f3] dark:divide-[#27272a] text-sm">
                  {leadsList.map((lead) => (
                    <tr key={lead.id} className="hover:bg-[#fafafa] dark:hover:bg-[#1e2026]">
                      <td className="p-4 font-mono text-xs text-[#0d74ce]">{lead.id}</td>
                      <td className="p-4 font-medium text-[#171717] dark:text-[#f4f4f5]">{lead.name}</td>
                      <td className="p-4 font-mono text-xs text-[#171717] dark:text-[#f4f4f5]">{lead.phone}</td>
                      <td className="p-4 text-[#171717] dark:text-[#f4f4f5]">{lead.service}</td>
        ...
        {activeTab === "services" && (
          <div className="space-y-6">
            <h3 className="text-xl font-semibold text-[#171717] dark:text-[#f4f4f5]">Active Monthly Services</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {SOCIAL_MEDIA_PLANS.map((plan) => (
                <div key={plan.id} className="card-surface p-6 space-y-3 bg-white dark:bg-[#14161b] border border-[#dcdee0] dark:border-[#27272a] rounded-xl">
                  <div className="flex justify-between items-center">
        ...
        {activeTab === "portfolio" && (
          <div className="space-y-6">
            <h3 className="text-xl font-semibold text-[#171717] dark:text-[#f4f4f5]">Manage Case Studies</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {PORTFOLIO_ITEMS.slice(0, 3).map((item) => (
                <div key={item.id} className="card-surface p-4 space-y-2 bg-white dark:bg-[#14161b] border border-[#dcdee0] dark:border-[#27272a] rounded-xl">
