...
export const SOCIAL_MEDIA_PLANS: ServicePlan[] = [
	{
		...
		features: [
			"10 High-Quality Posts per Month",
			"3 Custom Edited Reels per Month",
			"Custom Post Design",
			"Festival Posts Free",
			"Caption on Every Post",
			"30 Days Profile Management",
			"Complete Profile Setup",
			"5 Story Uploads",
			"Includes 2 Social Media Handles",
		],
	...
	},
	{
		...
		period: "Per user/month, billed annually",
		features: [
			"15 High-Quality Posts per Month",
			"5 HD Custom Reels per Month",
			"Sale & Discount Posts",
			"Festival Posts Free",
			"Caption on Every Post",
			"Unlimited Story Support",
			"Ad Running Support",
			"30 Days Profile Management",
			"Complete Profile Setup",
			"Includes 2 Social Media Handles",
...
export const FAQ_LIST: FaqItem[] = [
	...
	},
	{
		...
		answer:
			"Simply choose a plan (Basic ₹4,999, Super ₹5,999, or Premium ₹6,999) on our website or click the WhatsApp CTA. Our team will contact you within 2 hours to collect your brand logo, business details, and preferences.",
	},
	{
		id: "faq-3",
...
export const TESTIMONIALS: Testimonial[] = [
	{
		...
		content:
			"BizBuddy transformed our local store's online presence! Their ₹5,999 Super Social Media plan got us over 50 new walk-in customers in the very first month. Highly recommended!",
		rating: 5,
